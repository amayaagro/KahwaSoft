        ...
        <div class="content">
            ...
            <form action="" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                    class="form-control" name="nombreinsumo" id="nombreinsumo" value="" required aria-describedby="helpId" placeholder="Ingrese el nombre del insumo">
                </div>
                <div class="mb-3">
                    <label for="ingredienteactivo" class="form-label">Ingrediente Activo</label>
                    <input type="text"
                    class="form-control" name="ingredienteactivo" id="ingredienteactivo" value="" required aria-describedby="helpId" placeholder="Ingrese el ingrediente activo">
                </div>
                <div class="mb-3">
                    <label for="unidad" class="form-label">Unidad</label>
                    <input type="text"
                    class="form-control" name="unidad" id="unidad" aria-describedby="helpId" value="" required placeholder="Ingrese la unidad">
                </div>
                <div class="mb-3">
