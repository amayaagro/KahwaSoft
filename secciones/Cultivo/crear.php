        ...
        <div class="content">
            ...
            <form action="" method="post" class="form" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input type="text"
                    class="form-control" name="nombredelcultivo" id="nombredelcultivo" value="" required aria-describedby="helpId" placeholder="Ingrese el nombre del cultivo">
                </div>
                <div class="mb-3">
                    <label for="descripcion" class="form-label">Descripción</label>
                    <input type="text"
                    class="form-control" name="descripcion" id="descripcion" value="" required aria-describedby="helpId" placeholder="Ingrese la descripción">
                </div>
