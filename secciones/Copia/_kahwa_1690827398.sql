...
INSERT INTO cultivo VALUES("1","Café Variedad Colombia","Distancia de siembra 1x1 m, densidad 10.000 plantas/Ha.");
INSERT INTO cultivo VALUES("2","Café Variedad Caturra","Distancias de siembra, 1x1.2 m densidad de siembra 5000 plantas/Ha.");
INSERT INTO cultivo VALUES("3","Café Variedad Borbón","Distancia de siembra 2x2 m, densidad de siembra 2500 plantas/Ha.");
INSERT INTO cultivo VALUES("4","Café Variedad Tabí","Distancia de siembra 1.8x1.8 m, densidad de siembra 3086 plantas por/Ha.");
INSERT INTO cultivo VALUES("5","Café Variedad Castillo","Distancia de siembra 1x1 m, densidad de siembra 10.000 plantas/Ha.");
INSERT INTO cultivo VALUES("6","Café  Variedad Castillo","Distancia de siembra 1x1.2 m, densidad de siembra, 5.000 plantas /Ha. ");
INSERT INTO cultivo VALUES("7","Café Variedad Castillo Naranjal","Distancia de siembra 1x1 m, densidad de siembra 10.000 plantas/Ha.");
INSERT INTO cultivo VALUES("8","Café  Variedad Castillo Naranjal","Distancia de siembra 1x1.2 m, densidad de siembra 5.000 plantas/Ha.");
INSERT INTO cultivo VALUES("9","Café Variedad Castillo El Rosario","Distancia de siembra 1x1 m, densidad de siembra 10.000 plantas/Ha.");
INSERT INTO cultivo VALUES("10","Café Variedad Castillo El Rosario","Distancia de siembra 1x1.2 m, densidad de siembra 5.000 plantas/Ha.");
INSERT INTO cultivo VALUES("11","Café Variedad Castillo Paraguaicito","Distancia de siembra 1x1 m, densidad de siembra 10.000 plantas/Ha.");
INSERT INTO cultivo VALUES("12","Café Variedad Castillo Paraguaicito","Distancia de siembra 1x1.2 m, densidad de siembra 5.000 plantas/Ha.");
INSERT INTO cultivo VALUES("13","Café Variedad Castillo La Trinidad","Distancia de siembra 1x1 m, densidad de siembra 10.000 plantas/Ha.");
INSERT INTO cultivo VALUES("14","Café Variedad Castillo La Trinidad","Distancia de siembra 1x1.2 m, densidad de siembra 5.000 plantas/Ha.");
INSERT INTO cultivo VALUES("15","Café Variedad Castillo El Tambo","Distancia de siembra 1x1 m, densidad de siembra 10.000 plantas/Ha.");
INSERT INTO cultivo VALUES("16","Café Variedad Castillo El Tambo","Distancia de siembra 1x1.2 m, densidad de siembra 5.000 plantas/Ha.");
INSERT INTO cultivo VALUES("17","Café Variedad Castillo Santa Bárbara","Distancia de siembra 1x1 m, densidad de siembra 10.000 plantas/Ha.");
INSERT INTO cultivo VALUES("18","Café Variedad Castillo Santa Bárbara","Distancia de siembra 1x1.2 m, densidad de siembra 5.000 plantas/Ha.");
INSERT INTO cultivo VALUES("19","Plátano Variedad Dominico","Distancia de siembra 4x1.5 m, densidad de siembra 1.666 plantas/Ha.");
INSERT INTO cultivo VALUES("20","Plátano Variedad Dominico Hartón","Distancia de siembra 4x1,5 m densidad de siembra 1.666 plantas/Ha.");
INSERT INTO cultivo VALUES("21","Banano Criollo","Distancia de siembra 4 x1.5 m, densidad de siembra 1.666 plantas/Ha.");
INSERT INTO cultivo VALUES("22","Banano Variedad Cavendish","Distancia de siembra 4x1 m, densidad de siembra 2500 plantas/Ha.");
INSERT INTO cultivo VALUES("23","Banano variedad Gross Mitchell","Distancia de siembra 4x1 m, densidad de siembra 2500 plantas/Ha.");
INSERT INTO cultivo VALUES("24","Maíz","Distancia de siembra 0.50x0.46x0.46 m, densidad de siembra 94.517 plantas/Ha.");
INSERT INTO cultivo VALUES("25","Frijol","Distancia de siembra 0,5x0,46x0,46 m, densidad de siembra 94.517 plantas/Ha.
Acciones  ");
...
INSERT INTO equipo VALUES("2","2023-04-15","Fumigadora de Espalda Aplicacion Foliares","2","0000-00-00","0000-00-00","1","0000-00-00","1");
INSERT INTO equipo VALUES("3","2023-04-15","Fumigadora de Espalda MIPE","2","0000-00-00","0000-00-00","1","0000-00-00","1");
...
INSERT INTO equipo VALUES("11","2023-04-15","Máquina Despulpadora","2","2023-06-12","2023-12-06","9","2023-12-06","1");
...
INSERT INTO equipo VALUES("47","2023-04-15","Báscula","1","0000-00-00","0000-00-00","1","0000-00-00","1");
...
INSERT INTO labores VALUES("1","Construcción del Germinador.","Construcción o adecuación del germinador para que las semillas de café germinen y donde se mantienen hasta que aparezca el primer par de hojas.");
INSERT INTO labores VALUES("2","Llenado de Bolsas.","Actividad de llenado de las bolsas, con suelo cernido y pulpa de café descompuesta en relación 2 a 1.");
INSERT INTO labores VALUES("3","Siembra de Chapolas.","Proceso de traslado de las plántulas del germinador a las bolsas plásticas sembrando dos chapolas.");
INSERT INTO labores VALUES("4","Resiembra Almacigo.","Actividad de remplazo de las chapolas en el almacigo.");
INSERT INTO labores VALUES("5","Control Fitosanitario Almacigo.","Aplicación de fungicidas, insecticidas, nematicidas y herbicidas durante el almacigo.");
INSERT INTO labores VALUES("6","Preparación del Terreno.","Preparar el suelo para la siembra de la planta.");
INSERT INTO labores VALUES("7","Trazo.","Distribución, siguiendo la forma de figura geométrica en el terreno.");
INSERT INTO labores VALUES("8","Ahoyado.","Elaboración del hoyo para la siembra de 30 x 30 x 30 cm.");
INSERT INTO labores VALUES("9","Distribuir Colinos en el Lote.","Colocar las plántulas en cada sitio para la siembra.");
INSERT INTO labores VALUES("10","Aplicar Materia Orgánica.","Aplicacion de materia orgánica al plato de la planta.");
INSERT INTO labores VALUES("11","Siembra y Resiembra.","Siembra de colinos durante la siembra de un lote o el reemplazo de las plantas muertas.");
INSERT INTO labores VALUES("12","Fertilización (levante).","Aplicación de fertilizante a las plantas en proceso de levante.");
INSERT INTO labores VALUES("13","Control Arvenses Calles (levante).","Control químico con selector de arvenses, bomba de espalda o mecánico con guadaña.");
INSERT INTO labores VALUES("14","Control Arvenses Platos (levante).","Plateo manual con machete en el plato del árbol.");
INSERT INTO labores VALUES("15","Control Mecánico Machete.","Conttol con machete en los platos.");
INSERT INTO labores VALUES("16","Control Manual de Arvenses.","Control manual de arvenses con las manos en el plato.");
INSERT INTO labores VALUES("17","Control Arvenses Herbicida.","Aplicación de herbicida químico con bomba de espalda para el control de arvenses.");
INSERT INTO labores VALUES("18","Control Mecánico Arvenses Guadaña.","Control mecánico de arvenses con la guadaña.");
INSERT INTO labores VALUES("19","Aplicación de Fertilizante al Suelo.","Aplicación manual de fertilizante químico en el plato de la planta.");
INSERT INTO labores VALUES("20","Aplicación de Fertilizantes Foliares.","Aplicación de fertilizante foliar.");
INSERT INTO labores VALUES("21","Control de Broca.","Aplicación de insecticidas para el control de la broca Hypothenemus hampei.");
INSERT INTO labores VALUES("22","Control de Roya.","Aplicación de fungicidas para el control de la roya Hemileia vastatrix");
INSERT INTO labores VALUES("23","Control de Mancha de Hierro.","Aplicación de fungicidas para el control de la mancha de hierro Cercospora coffeicola.");
INSERT INTO labores VALUES("24","Control Otros Insectos.","Aplicación de insecticidas para el control de insectos.");
INSERT INTO labores VALUES("25","Control Otras Enfermedades.","Aplicación de fungicidas, nematicidas, acaricidas o bactericidas para el control de diferentes enfermedades.");
INSERT INTO labores VALUES("26","Deschuponados Cultivos en Producción.","Eliminación de ramas de la zona baja de las plantas.");
INSERT INTO labores VALUES("27","Descumbrar, Desrames de Sombrío del Cafetal.","Eliminar las ramas superiores de la planta, podas de formación y sanitarias.");
INSERT INTO labores VALUES("28","Desorillar, Controlar Arvenses","Quitar las ramas que se superponen dentro del cultivo y las especies que invaden el cultivo.");
INSERT INTO labores VALUES("29","Recolección al Día (Kg.).","Pago de producción por kilo de café pergamino recolectado en un día.");
INSERT INTO labores VALUES("30","Recolección Kilo (Kg.).","Pago de producción por kilo de café pergamino recolectado.");
INSERT INTO labores VALUES("31","Evaluación de la Recolección.","Actividad para la recolección de café no recogido en la planta y en el suelo o comúnmente llamado RERE (Proceso de repase y repele).");
INSERT INTO labores VALUES("32","Evaluación de la Calidad de la Cosecha.","Proceso de la evaluación de la calidad de la recolección del café por lotes.");
INSERT INTO labores VALUES("33","Patrón de Corte.","Persona encargada del peso final de cada recolección diaria por lote.");
INSERT INTO labores VALUES("34","Despulpar, Fermentar y Lavar.","Proceso de despulpado, fermentación del café y lavado del mucilago.");
INSERT INTO labores VALUES("35","Patiería","Persona encargada del proceso final de beneficio del café.");
INSERT INTO labores VALUES("36","Trasporte de Café Mojado.","Actividad de transporte de café despulpado para la zona de secado.");
INSERT INTO labores VALUES("37","Secado Mecánico o al Sol.","Secado de los frutos de café en secador mecánico o en helda.");
INSERT INTO labores VALUES("38","Empaque y Transporte.","Proceso de empaque y transporte del café, ya sea en el lote al momento del pesaje o para el envío hacia el centro de acopio.");
INSERT INTO labores VALUES("39","Evaluación del Nivel de Infestación.","Proceso de evaluación del nivel de infestación de plagas y enfermedades en especial broca y roya en los lotes.");
INSERT INTO labores VALUES("40","Zoca.","Proceso de renovación del cafetal realizado cada cuatro o cinco años.");
INSERT INTO labores VALUES("41","Eliminación de Arboles con Sierra Manual.","Proceso de eliminación de los arboles con sierra manual, para el proceso de zoca.");
INSERT INTO labores VALUES("42","Eliminación de Arboles con Motosierra.","Proceso de eliminación de los arboles con motosierra, para el proceso de zoca.");
INSERT INTO labores VALUES("43","Retirada de Material Grueso.","Proceso de retirada de las ramas y troncos de árboles zoqueados.");
INSERT INTO labores VALUES("44","Mantenimiento Beneficiadero.","Proceso de mantenimiento y limpieza del beneficiadero.");
INSERT INTO labores VALUES("45","Reparación Maquinaria ","Reparación de la maquinaria o mantenimiento preventivo.");
INSERT INTO labores VALUES("46","Aplicación de Correctivos.","Proceso de aplicación de correctivos para mejoramiento de las condiciones del suelo.");
INSERT INTO labores VALUES("47","Limpia Antes del Desrame.","Proceso de eliminacion de hojas y frutos no recolectados.");
INSERT INTO labores VALUES("48","Protección de Cortes. ","Aplicacion de fitosanitarios para evitar pudriciones y enfermedades despues de la zoca.");
INSERT INTO labores VALUES("49","Control Arvenses de Lotes en Renovación.","Control químico con selector, bomba de espalda o mecánico con guadaña.");
INSERT INTO labores VALUES("50","Selección de Chupones.","Selección de las ramas productivas.");
INSERT INTO labores VALUES("51","Fertilización para Lotes en Renovación","Aplicación de fertilizante a las plantas despues de la zoca.");
INSERT INTO labores VALUES("52","Transporte de Fertilizante al Cultivo.","Transportar los bultos de fertilizante al lote.");
INSERT INTO labores VALUES("53","Deschuponada lotes en Producción.","Eliminación de ramas de la zona baja de las plantas.");
INSERT INTO labores VALUES("54","Desbejucada Lotes en Producción.","Proceso de quitar los bejucos de arvenses rastreras en el cultivo durante la producción.");
INSERT INTO labores VALUES("55","Otras Labores en Producción.","Proceso de realizar otras labores durante el cuclo productivo del cultivo.");
INSERT INTO labores VALUES("56","Otras Labores en Levante.","Proceso de realizar otras labores durante el levante del cultivo.");
INSERT INTO labores VALUES("57","Plateo Arvenses, Manual.","Control manual de arvenses en los platos del cultivo.");
INSERT INTO labores VALUES("58","Manipulación de Pulpa en Fosa.","Volteo de la pulpa en descompocisión para evitar contaminación y proliferación de microorganismos.");
INSERT INTO labores VALUES("59","Plateo Lotes en Producción","Proceso de control de arvenses en los platos durante el ciclo productivo.");
...
INSERT INTO trabajadores VALUES("1","0","NINGUNO","0","0001-01-01","NA","","1");
...
INSERT INTO trabajadores VALUES("11","30563987","Angela Ramirez","3154863368","1986-01-19","Nueva EPS","","0");
...
INSERT INTO trabajadores VALUES("17","75089365","Alexander Perez Ángel","3014569856","1975-10-06","Cafesalud EPS","","1");
...
INSERT INTO trabajadores VALUES("31","30458963","Andrea Cardona López 	","3125896347","1978-10-08","Nueva EPS","","1");
INSERT INTO trabajadores VALUES("32","75081069","Alberto Castaño Montoya","3158631479","1971-05-03","Nueva EPS","","1");
...
INSERT INTO trabajadores VALUES("36","58158641","Alexander Montoya","3281368965","1978-02-12","CaféSalud","","1");
...
INSERT INTO usuarios VALUES("1","Usuario","usuario@mail.com","Usuario","1234","1","","");
INSERT INTO usuarios VALUES("2","Kahwasoft","kahwasoft@gmail.com","Kahwasoft","123456","1","904209","2023-07-28 13:33:52");
