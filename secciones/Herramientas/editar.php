...
<div class="card">
        <div class="content">
            <div class="title">
            <h3 id="Titulo"><strong>Modificar Herramienta</strong><img src="../../Img/Logo.png" width="230" height="80" align="right"></h3>
            </div>
            <div class="card-body">
            <form action="" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="date"
                    value="<?php echo $FechaInventario;?>"
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                    value="<?php echo $NombreHerramienta;?>"
                    class="form-control" name="nombreherramienta" id="nombreherramienta" aria-describedby="helpId" placeholder="Ingrese el nombre de la herramienta">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="date"
                    value="<?php echo $FechaDeRecibido;?>"
                ...
                <div class="mb-3">
                    ...
                    <input type="date"
                    value="<?php echo $FechaDeReemplazo;?>"
                    class="form-control" name="fechadereemplazo" id="fechadereemplazo" aria-describedby="helpId" placeholder="">
                </div>
                </br>
