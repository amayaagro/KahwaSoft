    ...
    <div align="center">
            <table class="table" id="tabla_id" align="center" width="1000" border="1" cellspacing="1">
                   <thead>
                        ...
                        <th scope="col"><div align="center">Fecha de Entrega</div></th>
                        <th scope="col"><div align="center">Fecha de Recibido</div></th>
                        <th scope="col"><div align="center">Fecha de Reemplazo</div></th>
                        ...
                        <tbody>   
                            ...
                            <tr class="">
                            <td><div align="left"><?php echo $herramienta['NombreHerramienta']; ?></div></td>
                            <td><div align="center"><?php echo $herramienta['Cantidad']; ?></div></td>
                            <td><div align="left"><?php echo $herramienta['empleado']; ?></div></td>
                            <td><div align="center"><?php echo $herramienta['FechaDeEntrega']; ?></div></td>
                            <td><div align="center"><?php echo $herramienta['FechaDeRecibido']; ?></div></td>
                            <td><div align="center"><?php echo $herramienta['FechaDeReemplazo']; ?></div></td>
