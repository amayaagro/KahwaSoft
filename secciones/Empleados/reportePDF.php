  	...
  	<div align="center">
    	  <table class="table" id="tabla_id" align="center" width="1000" border="1" cellspacing="1">
                <thead>
                    ...
                    <th scope="col"><div align="center">Teléfono</div></th>
                    <th scope="col"><div align="center">Fecha de Nacimiento</div></th>
                    <th scope="col"><div align="center">EPS</div></th>
                    <th scope="col"><div align="center">ARL</div></th>
                ...
                <tr class="">
                    <td><div align="left"><?php echo $empleado['Nombre']; ?></div></td>
                    <td><div align="center"><?php echo $empleado['Documento'];?></div></td>
                    <td><div align="center"><?php echo $empleado['Telefono']; ?></div></td>
                    <td><div align="center"><?php echo $empleado['FechaDeNacimiento'];?></div></td>
                    <td><div align="left"><?php echo $empleado['Eps'];?></div></td>
                    <td><div align="left"><?php echo $empleado['Arl']; ?></div></td>
