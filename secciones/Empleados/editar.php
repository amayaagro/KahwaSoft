        ...
        <div class="content">
            ...
            <form action="" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    class="form-control" name="documento" id="documento" aria-describedby="helpId" placeholder="Ingrese el documento">
                </div>
                <div class="mb-3">
                    <label for="nombrecompleto" class="form-label">Nombre Completo</label>
                    <input type="text"
                    value="<?php echo $nombre ?>"
                    class="form-control" name="nombrecompleto" id="nombrecompleto" aria-describedby="helpId" placeholder="Ingrese el nombre completo">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                    value="<?php echo $eps ?>"
                    class="form-control" name="eps" id="eps" aria-describedby="helpId" placeholder="Ingrese la eps">
                </div>
                <div class="mb-3">
