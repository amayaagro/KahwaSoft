    ...
    <div align="center">
            <table class="table" id="tabla_id">
                   <thead>
                       ...
                       <tr> 
                       <th scope="col"><div align="center">Fecha de Recolección</div></th>
                       <th scope="col"><div align="center">Responsable</div></th>
                       <th scope="col"><div align="center">Kilos Recolectados</div></th>
                       <th scope="col"><div align="center">Jornales Empleados</div></th>
                       <th scope="col"><div align="center">Valor Neto</div></th>
                       <th scope="col"><div align="center">Descuentos</div></th>
                    ...
                    <tr class="">
                        <td scope="row"><div align="center"><?php echo $recolector['FechaDeRecoleccion']; ?></div></td>
                        <td scope="row"><div align="left"><?php echo $recolector['empleado']; ?></div></td>
                        <td scope="row"><div align="center"><?php echo $recolector['KilosRecolectados']; ?></div></td>
                        <td scope="row"><div align="center"><?php echo $recolector['JornalesRecoleccion']; ?></div></td>
                        <td scope="row"><div align="center"><?php echo $recolector['ValorNeto']; ?></div></td>
                        <td scope="row"><div align="center"><?php echo $recolector['Descuentos']; ?></div></td>
                        <td scope="row"><div align="center"><?php echo $recolector['Total']; ?></div></td>
                        <?php if($recolector['Estado']==1){ ?>
                        <td><div align="center">Activo</div></td>
                        <?php }?>
                        <?php if($recolector['Estado']==0){ ?>
                        <td><div align="center">Inactivo</div></td>
                        <?php }?>
                        </tr>
                        <?php }?>
                    </tbody>
