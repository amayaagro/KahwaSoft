    ...
    <div align="center">
        <table class="table" id="tabla_id" align="center" width="1000" border="1" cellspacing="1">
            ...
            <tr>
                ...
                <th scope="col"><div align="center">Fecha de Mantenimiento</div></th>
            ...
            <tbody>   
                ...
                <tr class="">
                    <td><div align="left"><?php echo $equipo['NombreEquipo']; ?></div></td>
                    <td><div align="center"><?php echo $equipo['Cantidad']; ?></div></td>
                    <td><div align="center"><?php echo $equipo['empleado']; ?></div></td>
                    <td><div align="center"><?php echo $equipo['FechaDeEntrega']; ?></div></td>
                    <td><div align="center"><?php echo $equipo['FechaDeRecibido']; ?></div></td>
                    <td><div align="center"><?php echo $equipo['FechaDeMantenimiento']; ?></div></td>
