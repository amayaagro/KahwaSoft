...
<div class="card">
        <div class="content">
            <div class="title">
            <h3 id="Titulo"><strong>Modificar Equipo</strong><img src="../../Img/Logo.png" width="230" height="80" align="right"></h3>
            </div>
            <div class="card-body">
            <form action="" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    class="form-control" name="nombreequipo" id="nombreequipo" aria-describedby="helpId" placeholder="Ingrese el nombre del equipo">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="date"
                    value="<?php echo $FechaDeMantenimiento;?>"
