...
<div class="card">
        <div class="content">
            <div class="title">
            <h3 id="Titulo"><strong>Registrar Lote</strong><img src="../../Img/Logo.png" width="230" height="80" align="right"></h3>
            </div>
            <div class="card-body">
            <form action="" method="post" class="form" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input type="text"
                    class="form-control" name="nombrelote" id="nombrelote" value="" required aria-describedby="helpId" placeholder="Ingrese el nombre del lote">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number"
                    class="form-control" name="tamaño" id="tamaño" value="" required aria-describedby="helpId" placeholder="Ingrese el tamaño del lote">
                </div>
                <div class="mb-3">
