...
<div class="card">
        <div class="content">
            <div class="title">
            <h3 id="Titulo"><strong>Modificar Lote</strong><img src="../../Img/Logo.png" width="230" height="80" align="right"></h3>
            </div>
            <div class="card-body">
            <form action="" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                    value="<?php echo $nombredelote;?>"
                    class="form-control" name="nombrelote" id="nombrelote" aria-describedby="helpId" placeholder="Ingrese el nombre del lote">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    class="form-control" name="tamaño" id="tamaño" aria-describedby="helpId" placeholder="Ingrese el tamaño del lote">
                </div>
                <div class="mb-3">
                    <label for="fechadesiembra" class="form-label">Fecha de Siembra</label>
                    <input type="date"
                    value="<?php echo $FechaDeSiembra;?>"
                    class="form-control" name="fechadesiembra" id="fechadesiembra" aria-describedby="helpId" placeholder="">
                </div>
                </br>
