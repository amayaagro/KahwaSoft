...
<div class="card">
        <div class="content">
            <div class="title">
            <h3 id="Titulo"><strong>Modificar Finca</strong><img src="../../Img/Logo.png" width="230" height="80" align="right"></h3>
            </div>
            <div class="card-body">
            <form action="" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    class="form-control" name="nombredelpredio" id="nombredelpredio" aria-describedby="helpId" placeholder="Ingrese el nombre del predio">
                </div>
                <div class="mb-3">
                    <label for="vereda" class="form-label">Vereda</label>
                    <input type="text"
                    value="<?php echo $vereda;?>"
                    class="form-control" name="vereda" id="vereda" aria-describedby="helpId" placeholder="Ingrese la vereda">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number"
                    value="<?php echo $tamano;?>"
                    class="form-control" name="tamaño" id="tamaño" aria-describedby="helpId" placeholder="Ingrese el tamaño">
                </div>
                <div class="mb-3">
                <label for="temperatura" class="form-label">Temperatura (°C)</label>
                    <input type="number"
                    value="<?php echo $temperatura;?>"
                    class="form-control" name="temperatura" id="temperatura" aria-describedby="helpId" placeholder="ingrese la temperatura">
                </div>
                <div class="mb-3">
                <label for="brillosolar" class="form-label">Brillo Solar (h/año)</label>
                    <input type="number"
                    value="<?php echo $brilloSolar;?>"
                    class="form-control" name="brillosolar" id="brillosolar" aria-describedby="helpId" placeholder="Ingrese el brillo solar">
                </div>
                <div class="mb-3">
                <label for="lluvia" class="form-label">Lluvia (mm)</label>
                    <input type="number"
                    value="<?php echo $lluvia;?>"
                    class="form-control" name="lluvia" id="lluvia" aria-describedby="helpId" placeholder="Ingrese la lluvia">
                </div>
                <div class="mb-3">
                <label for="humedadrelativa" class="form-label">Humedad Relativa (%HR)</label>
                    <input type="number"
                    value="<?php echo $humedadrelativa;?>"
                    class="form-control" name="humedadrelativa" id="humedadrelativa" aria-describedby="helpId" placeholder="Ingrese la humedad relativa">
                </div>
                <div class="mb-3">
                <label for="relieve" class="form-label">Relieve (plano, ondulado, quebrado)</label>
                    <input type="text"
                    value="<?php echo $relieve;?>"
                    class="form-control" name="relieve" id="relieve" aria-describedby="helpId" placeholder="Ingrese el relieve">
                </div>
                <div class="mb-3">
                <label for="altura" class="form-label">Altura (m.s.n.m)</label>
                    <input type="number"
                    value="<?php echo $altura;?>"
                    class="form-control" name="altura" id="altura" aria-describedby="helpId" placeholder="Ingrese la altura">
                </div>
                </br>
