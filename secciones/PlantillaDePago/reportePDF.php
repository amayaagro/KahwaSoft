    ...
    <div align="center">
                    <table class="table" id="tabla_id" align="center" width="1000" border="1" cellspacing="1">
                        <thead>
                            ...
                            <tr>
                            <th scope="col"><div align="center">Fecha de Pago</div></th>
                            <th scope="col"><div align="center">Trabajador</div></th>
                            <th scope="col"><div align="center">Valor Neto</div></th>
                            <th scope="col"><div align="center">Descuentos</div></th>
                            <th scope="col"><div align="center">Valor a Pagar</div></th>
                        ...
                        <tbody>   
                            <?php foreach($devengado as $pago) {?>
                                <tr class="">
                                    <td scope="row"><div align="center"><?php echo $pago['FechaDePago']; ?></div></td>
                                    <td scope="row"><div align="left"><?php echo $pago['empleado']; ?></div></td>
                                    <td scope="row"><div align="center"><?php echo $pago['Sueldo']; ?></div></td>
                                    <td scope="row"><div align="center"><?php echo $pago['Descuento']; ?></div></td>
                                    <td scope="row"><div align="center"><?php echo $pago['ValorTotal']; ?></div></td>
