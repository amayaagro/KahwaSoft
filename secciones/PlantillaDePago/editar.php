...
<div class="card">
        <div class="content">
            <div class="title">
            <h3 id="Titulo"><strong>Modificar Pago</strong><img src="../../Img/Logo.png" width="230" height="80" align="right"></h3>
            </div>
            <div class="card-body">
            <form action="" method="post" class="form" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="date"
                    value="<?php echo $FechaDePago;?>"
                    class="form-control" name="fechadepago" id="fechadepago" aria-describedby="helpId" placeholder="">
                </div>
                <div class="mb-3">
               ...
               <div class="mb-3">
                    ...
                    class="form-control" name="sueldo" id="sueldo" aria-describedby="helpId" placeholder="Ingrese el valor neto">
                </div>
                <div class="mb-3">
                    <label for="descuento" class="form-label">Descuento</label>                    
                    <input type="number" onChange="CalcularTotal()"
                    value="<?php echo $Descuento;?>"
                    class="form-control" name="descuento" id="descuento" aria-describedby="helpId" placeholder="Ingrese el descuento">
                </div>
                <div class="mb-3">
                    <label for="valortotal" class="form-label">Valor a Pagar</label>
                    <input type="number"
                    value="<?php echo $ValorTotal;?>"
                    class="form-control" name="valortotal" id="valortotal" aria-describedby="helpId" placeholder="Ingrese el valor a pagar">
                </div>
                </br>
