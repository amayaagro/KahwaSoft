    ...
    <div align="center">
            <table class="table" id="tabla_id" align="center" width="1000" border="1" cellspacing="1">
                    <thead>
                        ...
                        <th scope="col"><div align="center">Finca</div></th>
                        <th scope="col"><div align="center">Lote</div></th>
                        <th scope="col"><div align="center">Responsable</div></th>
                        <th scope="col"><div align="center">Labor</div></th>
                    ...
                    <tbody>   
                        ...
                        <tr class="">
                        <td><div align="center"><?php echo $tarea['FincaDeTrabajo']; ?></div></td>
                        <td><div align="center"><?php echo $tarea['LoteDeTrabajo']; ?></div></td>
                        <td><div align="left"><?php echo $tarea['empleado']; ?></div></td>
                        <td><div align="left"><?php echo $tarea['LaborDeTrabajo']; ?></div></td>
