    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div class="card">
                <div class="content">
                    <div class="title">
                    <center><h3 id="Titulo"><strong>Inicio de Sesión</strong></h3></center>
                    </div>
                    <br>
                    <div class="card-body">
                    ...
                    <p><img src="img/logo.png" width="100%" Background-color="transparent"></p>
                            <div class="mb-3">
                                ...
                                <input type="email"
                                    ...
                                    class="form-control" name="correo" id="correo" title="Correo" aria-describedby="helpId" placeholder="Ingrese su correo electrónico">
                            </div>
                            <div class="mb-3">
                                <label for="password" class="form-label"><h5>Contraseña</h5></label>
                                <input type="password"
                                    class="form-control" name="password" id="password" title="Contraseña" aria-describedby="helpId" placeholder="Escriba Su Password">
                            </div>
                            <br>
                            <br>
